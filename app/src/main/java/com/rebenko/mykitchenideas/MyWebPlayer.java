...
public class MyWebPlayer extends WebView {
    ...
    public MyWebPlayer(Context context) {
        super(context);
    }

    public MyWebPlayer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public void initialize(String videoUrl,FacebookListener listener){
        if(listener != null){
    ...
    private String getVideoHTML(String videoUrl){
        try {
            InputStream in = getResources().openRawResource(R.raw.webplay);
            if (in != null) {
    ...
    public void setAutoPlayerHeight(Context context) {
        ...
        this.getLayoutParams().height = (int) (displayMetrics.widthPixels);
    }
}